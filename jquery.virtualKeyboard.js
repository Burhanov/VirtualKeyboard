;(function($){
    ...
    var virtualKeyboard = {
        template: '<div id="vkb-js-keyboard" class="vkb-css-hide"><div class="vkb-css-background vkb-js-close"></div><div class="vkb-css-keyboard-box"><div class="vkb-css-input-box"><input type="text" id="vkb-js-input" class="vkb-css-input"/></div><div class="vkb-css-button-box"><div class="vkb-css-button-line"> <button type="button">!</button> <button type="button">@</button> <button type="button">#</button> <button type="button">$</button> <button type="button">%</button> <button type="button">^</button> <button type="button">?</button> <button type="button">*</button> <button type="button">/</button></div><div class="vkb-css-button-line"> <button type="button">1</button> <button type="button">2</button> <button type="button">3</button> <button type="button">4</button> <button type="button">5</button> <button type="button">6</button> <button type="button">7</button> <button type="button">8</button> <button type="button">9</button> <button type="button">0</button>      <button type="button" id="vkb_8">< backspace</button></div><div class="vkb-css-button-line"> <button type="button">й</button> <button type="button">ц</button> <button type="button">у</button> <button type="button">к</button> <button type="button">е</button> <button type="button">н</button> <button type="button">г</button> <button type="button">ш</button> <button type="button">щ</button> <button type="button">з</button> <button type="button">х</button> <button type="button">ъ</button></div><div class="vkb-css-button-line"> <button type="button">ф</button> <button type="button">ы</button> <button type="button">в</button> <button type="button">а</button> <button type="button">п</button> <button type="button">р</button> <button type="button">о</button> <button type="button">л</button> <button type="button">д</button> <button type="button">ж</button> <button type="button">э</button></div><div class="vkb-css-button-line"> <button type="button">я</button> <button type="button">ч</button> <button type="button">с</button> <button type="button">м</button> <button type="button">и</button> <button type="button">т</button> <button type="button">ь</button> <button type="button">б</button> <button type="button">ю</button></div><div class="vkb-css-button-line"> <button type="button" id="vkb_32"> </button> <button type="button"id="vkb_37"><</button> <button type="button"id="vkb_39">></button></div></div><div class="vkb-css-footer-box"> <button type="button" id="vkb_close">Отмена</button> <button type="button" id="vkb_success">ОК</button></div></div></div>',
